...
const faqItems = [
  {
    ...
    answer: "AgriClim est une plateforme qui connecte les agriculteurs aux données climatiques et aux recommandations de cultures adaptées à leur région. Nous aidons à optimiser les pratiques agricoles grâce à des données précises et des conseils personnalisés."
  },
  {
  ...
  },
  {
    ...
    answer: "Oui, nous utilisons des sources de données météorologiques de premier ordre et mettons à jour nos prévisions en temps réel. Nos algorithmes combinent plusieurs modèles météorologiques pour offrir les prévisions les plus précises possibles pour votre localisation spécifique."
  },
  {
...
const testimonials = [
  {
    ...
    testimonial: "Grâce à AgriClim, j'ai pu anticiper une période de gel tardif et protéger mes vignes. Les prévisions précises m'ont fait gagner une année de récolte. Un outil indispensable pour tout viticulteur consciencieux !"
  },
  {
    id: 2,
    name: "Marie Legrand",
  ...
  },
  {
    ...
    testimonial: "Avec les périodes de sécheresse qui s'intensifient, AgriClim m'a permis d'optimiser mon irrigation. J'économise 30% d'eau tout en maintenant la qualité de mes fruits. C'est bon pour la planète et pour mon porte-monnaie !"
  },
  {
    id: 4,
    name: "Sophie Martin",
    region: "Occitanie",
    culture: "Grandes cultures",
  ...
  },
  {
    ...
    name: "Pierre Dubois",
    region: "Normandie",
    culture: "Élevage laitier",
    avatar: "https://i.pravatar.cc/150?img=15",
    testimonial: "J'utilise AgriClim pour planifier mes semis de fourrage. Les prévisions saisonnières m'ont permis d'adapter mes pratiques au changement climatique. Mes vaches ne manquent plus de nourriture, même lors des étés difficiles."
  },
  {
    id: 6,
    name: "Isabelle Rousseau",
    region: "Auvergne-Rhône-Alpes",
    culture: "Agriculture de montagne",
    avatar: "https://i.pravatar.cc/150?img=16",
    testimonial: "En zone de montagne, la météo peut changer très vite. AgriClim me donne des alertes précises qui me permettent d'anticiper. C'est comme avoir un météorologue personnel qui connaît parfaitement mon terrain !"
  }
];
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="hero-section pt-28 pb-16 md:pt-40 md:pb-24 relative">
        <div 
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1500382017468-9049fed747ef?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2532&q=80')" }}
        ></div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10 reveal">
            <h2 className="text-xl text-gray-500 font-medium">Ils nous font confiance</h2>
          </div>
